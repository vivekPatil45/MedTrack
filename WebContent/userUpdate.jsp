    ...
    %>
        ...
        <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
            <div class="form-title">
                <h4 style="text-align: center;">Update User Current Location</h4>
            </div>
            <div class="form-body">
                <form action="UpdateLocationOfUser" method="post"> 
                    <div class="form-group"> 
                        <label for="exampleInputEmail1">User Current Longitude</label> 
                        <input type="text" name="ulongitude" class="form-control"id="exampleInputEmail1" placeholder="Longitude" value="<%=lng%>"> 
                    </div> 
                    <div class="form-group"> 
                        <label for="exampleInputEmail1">User Current Latitude</label> 
                        <input type="text" name="ulatitude" class="form-control"id="exampleInputEmail1" placeholder="Longitude" value="<%=lat%>"> 
                    </div>           					
