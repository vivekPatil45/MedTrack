        ...
        <div class="main-page">
            <div class="tables">
                ...
                <div class="table-responsive bs-example widget-shadow">
                    ...
                    <h4 style="text-align: center;color: #35A29F;">Near By Expire Medicine</h4>
         	...
         	<%
    			...
    			try{
	        				...
	        				PreparedStatement ps = con.prepareStatement("SELECT *,DATEDIFF(medicine_tbl.med_exp,CURRENT_DATE) AS date_diff FROM medicine_tbl INNER JOIN medical_tbl ON medicine_tbl.memail= medical_tbl.memail ORDER BY date_diff");				
        	...
        	<%     				
    			...
    			{    		
    				System.out.println("Something went wrong in NearybyExpire");
    				e.printStackTrace();
    			}
    		%>	  
