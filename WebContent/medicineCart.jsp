            ...
            <div class="tables">
         	...
         	<%
    				...
    				try{	    					    
	        				...
	        				PreparedStatement ps = con.prepareStatement("SELECT * FROM ((medicine_tbl INNER JOIN medical_tbl ON medicine_tbl.memail= medical_tbl.memail) INNER JOIN order_tbl on order_tbl.memail=medicine_tbl.memail) WHERE order_tbl.med_id=medicine_tbl.med_id and order_tbl.uemail=?");				
